...
CLIConfig::CLIConfig() {
    ...
    cliOptions = {
            ...
            { option_requirement::Optional,
                    {"trace", 't', argument_requirement::NO_ARG,
                            "Toggle tracing of the input automata. Use with '--trace-output' and '--trace-steps' option"} },
            { option_requirement::Optional,
                    {"trace-steps", 's', argument_requirement::REQUIRE_ARG,
                            "[1-N] Trace only the provided amount of steps"} },
            { option_requirement::Optional,
