...
namespace aaltitoad::ctl {
    ...
    using ex_query = query_t<Exists, Next>;
    using eg_query = query_t<Exists, Globally>;
    using ef_query = query_t<Exists, Finally>;
    using eu_query = query_t<Exists, Until, std::pair<expr::compiler::compiled_expr_t, expr::compiler::compiled_expr_t>>;
    using ew_query = query_t<Exists, WeakUntil, std::pair<expr::compiler::compiled_expr_t, expr::compiler::compiled_expr_t>>;
